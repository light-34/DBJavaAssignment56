...
public class ClientGUI extends JFrame {
	...
	private Socket socketHolder = null;
	...
	public ClientGUI() {
		...
		btnConnect.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// have to define the host, ours is just a local host 
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				try {
					//dIn = new DataInputStream(socketHolder.getInputStream());
					dOut = new DataOutputStream(socketHolder.getOutputStream());
					...
					dOut.writeUTF( fName + ","+ lName + ","+ address + ","+ city + ","+ 
					prov + ","+ postal + ","+ phone + ","+ email + "," + action );
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				try {
					// try to establish connection with server
					// need to reference currecnt socket from connect button 
					
					socketHolder.close();	// closed connection 				
